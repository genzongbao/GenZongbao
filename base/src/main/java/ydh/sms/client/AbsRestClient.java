...
import ydh.sms.utils.SSLHttpClient;
import ydh.sms.utils.SysConfig;

@SuppressWarnings("deprecation")
public abstract class AbsRestClient {
	public final boolean isTest=Boolean.parseBoolean(SysConfig.getInstance().getProperty("is_test"));
	public final String server=SysConfig.getInstance().getProperty("rest_server");
	public final String sslIP=SysConfig.getInstance().getProperty("http_ssl_ip");
	public final int sslPort=SysConfig.getInstance().getPropertyInt("http_ssl_port");
	public final String version=SysConfig.getInstance().getProperty("version");
	public final String sid = SysConfig.getInstance().getProperty("AccessKeyID");
	public final String authToken = SysConfig.getInstance().getProperty("auth_token");
	public final String appId = SysConfig.getInstance().getProperty("app_id");
	 ...
	 * templateSMS
	 */
	public abstract String templateSMS(String templateId,String to,String param);
	 ...
	 * templateSMS
	 */
	public abstract String templateSMSCall(String templateId,String to,String param);
